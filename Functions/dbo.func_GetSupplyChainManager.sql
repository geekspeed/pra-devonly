...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[func_GetSupplyChainManager] (@userid varchar(50))
returns varchar(50)
as
Begin
	...
	Begin
		...
		--print @SUPERVISOR
		if exists(select 1 from tbl_workflow_lookup where lookuptype='SupplyChainManager' and lookupvalue=@SUPERVISOR +'@arubanetworks.com') AND (@SUPERVISOR <> @EMPGUY) 
		Begin
